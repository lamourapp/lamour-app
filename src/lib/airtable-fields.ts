...
// ─── Закупки матеріалів / tbliV1Qh8ls5Ak579 ────────────────────────────────
// Виплати постачальникам за товари та матеріали. Окремий грошовий потік:
// matCost (з послуг + costPrice з продажів) накопичується в "Фонд матеріалів",
// а ця таблиця фіксує реальні виплати з фонду. НЕ зараховується у звичайні
// витрати — matCost вже відняли з Чистого через pricing.ts. Без цього фонду
// власник не бачить різницю між "своїми" грошима і грошима постачальників,
// що лежать у касі.
