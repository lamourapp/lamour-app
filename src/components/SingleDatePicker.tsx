...
/**
 * SingleDatePicker — брендовий one-date picker, візуально ідентичний
 * CalendarPicker (range) з журналу/дешборду.
 *
 * ─── ПРОЕКТНА АКСІОМА ─────────────────────────────────────────────────
 * Це ЄДИНИЙ дата-пікер у проекті. НЕ використовуй нативний
 * `<input type="date">` або `<Input type="date">` у формах — вони
 * рендеряться стилем ОС/браузера і вибиваються з дизайну. Якщо з'явиться
 * нова форма з датою — постав сюди `<SingleDatePicker value onChange>`.
 *
 * API навмисне віддзеркалює `<Input type="date">`:
 *   value="YYYY-MM-DD"  onChange("YYYY-MM-DD")
 * щоб заміна була drop-in без перебудови стейту.
 * ──────────────────────────────────────────────────────────────────────
 */
