...
**Рекомендований порядок фіксу:**
1. Пункт 1 — `force-dynamic` у 6 файлів. 5 хв роботи, прибирає неочевидні баги «змін не видно». Після цього п.11 — прибрати `?_t=`.
2. Пункти 5 і 9 — лагідні корекції бекенду, низький ризик.
3. Пункти 3 і 7 — захист від rate-limit, важливо до підключення другого салону.
4. Пункти 2, 4, 6, 8, 12 — без поспіху, при наступних дотиках до файлів.
5. Пункт 10 — групово в одному коміті.
